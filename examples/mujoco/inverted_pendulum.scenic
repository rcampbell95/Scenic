...
friction1 = Normal(1, 0.1)


ego = new DynamicMujocoBody,
        with xml f"""
<mujoco model="inverted pendulum">
	<compiler inertiafromgeom="true"/>
	<default>
		<joint armature="0" damping="1" limited="true"/>
		<geom contype="0" friction="{friction1} 0.1 0.1" rgba="0.7 0.7 0 1"/>
		<tendon/>
		<motor ctrlrange="-3 3"/>
	</default>
	<size nstack="3000"/>
	...
	<actuator>
		...
		<motor ctrllimited="true" ctrlrange="-3 3" gear="100" joint="slider" name="ride"/>
	</actuator>
</mujoco>"""
